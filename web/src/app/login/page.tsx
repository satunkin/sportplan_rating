      ...
      <section className="mx-auto grid w-full max-w-5xl gap-8 lg:grid-cols-[0.85fr_1.15fr]">
        <article className="rounded-[2rem] bg-accent px-7 py-8 text-white shadow-[0_24px_90px_rgba(19,58,86,0.22)]">
          ...
          <p className="mt-5 text-base leading-7 text-white/82">
            Войдите по email, чтобы открыть свой кабинет, проверить статус
            поданных результатов и вернуться к рейтингу без повторной
            регистрации.
          </p>
          <Link
        ...
        <article className="rounded-[2rem] border border-border bg-surface px-7 py-8 shadow-[0_24px_70px_rgba(31,95,139,0.08)]">
          ...
          <p className="mt-4 max-w-2xl text-base leading-7 text-muted">
            Запросите ссылку для входа на свой email. Это основной способ
            авторизации для участника: без лишних паролей и с быстрым доступом
            к личному кабинету.
          </p>
          {magicLinkError ? (
          ...
          <div className="mt-6">
            <TechnicalNote>
              Пока production SMTP еще не подключен, dev-режим может показывать
              magic link прямо на экране. Это временное техническое поведение
              для проверки auth flow end-to-end.
            </TechnicalNote>
          </div>
          <div className="mt-8">
            <AthleteLoginForm />
